...
export const MOCK_SCHEDULES: PickupSchedule[] = [
  { id: 'p1', fault_id: 'f1', driver_id: 'mike',   assigned_by: 'karim', from_location_id: 'bilderdijk', to_location_id: 'hub-hfd', scheduled_date: '2026-05-07', time_from: '10:00', time_to: '11:30', vehicle_id: 'F-001', notes: 'Ayoub is aanwezig', status: 'planned',   created_at: '2026-05-06T09:00:00Z' },
  { id: 'p2', fault_id: 'f3', driver_id: 'mike',   assigned_by: 'karim', from_location_id: 'pieter',     to_location_id: 'hub-hfd', scheduled_date: '2026-05-07', time_from: '13:00', time_to: '14:30', vehicle_id: 'F-011', notes: null,              status: 'planned',   created_at: '2026-05-06T09:10:00Z' },
  { id: 'p3', fault_id: 'f6', driver_id: 'mike',   assigned_by: 'karim', from_location_id: 'molenwijk',  to_location_id: 'hub-hfd', scheduled_date: '2026-05-07', time_from: '15:30', time_to: '16:30', vehicle_id: 'F-040', notes: 'Alex aanwezig na 15:00', status: 'planned', created_at: '2026-05-06T09:20:00Z' },
  { id: 'p4', fault_id: 'f5', driver_id: 'isaac',  assigned_by: 'karim', from_location_id: 'hub-hfd',    to_location_id: 'hub-hfd', scheduled_date: '2026-05-07', time_from: '09:00', time_to: '10:00', vehicle_id: 'A-002', notes: 'Intern – band verwisselen', status: 'planned', created_at: '2026-05-06T09:30:00Z' },
  { id: 'p5', fault_id: 'f4', driver_id: 'isaac',  assigned_by: 'karim', from_location_id: 'hub-hfd',    to_location_id: 'linnaeus', scheduled_date: '2026-05-07', time_from: '11:00', time_to: '12:30', vehicle_id: 'F-021', notes: 'Bryan ontvangt', status: 'planned',   created_at: '2026-05-06T09:40:00Z' },
  { id: 'p6', fault_id: 'f2', driver_id: 'hassan', assigned_by: 'karim', from_location_id: 'hub-ens',    to_location_id: 'wesseler', scheduled_date: '2026-05-07', time_from: '09:30', time_to: '11:00', vehicle_id: 'S-011', notes: null,              status: 'planned',   created_at: '2026-05-06T09:50:00Z' },
  { id: 'p7', fault_id: null, driver_id: 'mike',   assigned_by: 'arjen', from_location_id: 'linnaeus',   to_location_id: 'hub-hfd', scheduled_date: '2026-04-30', time_from: '10:00', time_to: '11:00', vehicle_id: 'S-010', notes: 'Periodiek onderhoud', status: 'completed', created_at: '2026-04-29T10:00:00Z' },
]
